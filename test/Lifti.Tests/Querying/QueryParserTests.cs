...
namespace Lifti.Tests.Querying
{
    public class QueryParserTests
    {
        ...
        public QueryParserTests()
        {
            ...
            this.fieldLookupMock.Setup(l => l.GetFieldInfo("testfield")).Returns(new IndexedFieldDetails<TestObject>(testFieldId, nullFieldReader, FieldKind.Static, textExtractor, this.field1Tokenizer, thesaurus));
            this.fieldLookupMock.Setup(l => l.GetFieldInfo("otherfield")).Returns(new IndexedFieldDetails<TestObject>(otherFieldId, nullFieldReader, FieldKind.Static, textExtractor, this.field2Tokenizer, thesaurus));
        }
