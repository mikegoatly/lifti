...
namespace Lifti.Tests
{
    public class ObjectScoreBoostMetadataTests
    {
        ...
        {
            var metadata = ItemMetadata(new DateTime(2022, 11, 12), null);
        ...
        {
            var metadata = ItemMetadata(null, 100433D);
            this.sut.Add(metadata);
        ...
        {
            var minItem = ItemMetadata(new DateTime(1980, 11, 12), null);
            var maxItem = ItemMetadata(new DateTime(2022, 11, 12), null);
        ...
        {
            var minItem = ItemMetadata(null, -100D);
            var maxItem = ItemMetadata(null, 100433D);
            this.sut.Add(minItem);
            this.sut.Add(maxItem);
        ...
        {
            var minItem = ItemMetadata(null, -100D);
            var midItem = ItemMetadata(null, 400D);
            var maxItem = ItemMetadata(null, 900D);
            this.sut.Add(minItem);
        ...
        {
            var metadata = ItemMetadata(null, null);
            this.sut.Add(metadata);
